...
document.getElementById("resultado").innerHTML = `User ${nombre} has been deleted from contacts`;
});
...
document.getElementById("borrarTodos").addEventListener("click",function(){
    localStorage.clear();
    document.getElementById("resultado").innerHTML = `All users have been deleted from contacts`;
});